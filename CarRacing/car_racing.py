...
end_img = pygame.image.load('CarRacing/Assets/end.jpg')
end_img = pygame.transform.scale(end_img, (WIDTH, HEIGHT))
game_over_img = pygame.image.load('CarRacing/Assets/game_over.png')
game_over_img = pygame.transform.scale(game_over_img, (220, 220))
coin_img = pygame.image.load('CarRacing/Assets/coins/1.png')
dodge_img = pygame.image.load('CarRacing/Assets/car_dodge.png')

left_arrow = pygame.image.load('CarRacing/Assets/buttons/arrow.png')
right_arrow = pygame.transform.flip(left_arrow, True, False)

home_btn_img = pygame.image.load('CarRacing/Assets/buttons/home.png')
replay_img = pygame.image.load('CarRacing/Assets/buttons/replay.png')
sound_off_img = pygame.image.load("CarRacing/Assets/buttons/soundOff.png")
sound_on_img = pygame.image.load("CarRacing/Assets/buttons/soundOn.png")

cars = []
car_type = 0
for i in range(1, 9):
	img = pygame.image.load(f'CarRacing/Assets/cars/{i}.png')
...
nitro_counter = 0
for i in range(6):
	img = pygame.image.load(f'CarRacing/Assets/nitro/{i}.gif')
